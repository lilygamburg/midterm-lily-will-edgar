...
# Export to one TSV
dedf.to_csv('for_graph/de.tsv', sep='\t', index=False)
...
# Export to one TSV
endf.to_csv('for_graph/en.tsv', sep='\t', index=False)
...
# Export to one TSV
frdf.to_csv('for_graph/fr.tsv', sep='\t', index=False)
...
# Export to one TSV
hedf.to_csv('for_graph/he.tsv', sep='\t', index=False)
...
# Export to one TSV
rudf.to_csv('for_graph/ru.tsv', sep='\t', index=False)